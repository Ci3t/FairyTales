...
function CreateStory() {
	...
	return (
		<div className='bgKidImage mt-0 heightVH'>
					...
					<form onSubmit={handleSubmit}>
						<div className=' relative z-0  mb-6 w-full group'>
							<input
								...
								className='block py-2.5 px-0 w-full text-sm text-slate-200 bg-transparent border-0 border-b-2 border-slate-400 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-slate-500 focus:outline-none focus:ring-0 focus:border-slate-600 peer'
								placeholder=' '
								required
							/>
							<label
